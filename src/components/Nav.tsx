...
export const Nav = (props: styleProps) => {
    ...
    return (
        <>
            <header className={`flex justify-around items-center ${props.background} ${props.textColor} p-4`}>
                ...
                <label className="inline-flex relative items-center cursor-pointer">
                    ...
                    <span className={`ml-3 text-sm font-medium ${props.textColor}`}>Dark Theme</span>
                </label>
            </header>
        </>
    )
